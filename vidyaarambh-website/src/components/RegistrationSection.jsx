...
export default function RegistrationSection() {
    ...
    const tiers = [
        { name: 'Early Bird', price: '₹100', availability: 'First 50 Members', featured: true },
        { name: 'Late Bird', price: '₹150', availability: 'Next 30 Members' },
        { name: 'Final Call', price: '₹200', availability: 'Final 20 Members' },
    ];
    return (
